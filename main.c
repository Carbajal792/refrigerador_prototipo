...
int main (){
    ...
    int option = 0, option2 = 0, aux =0, cuenta=0;
    ListaSimple *bebida, *embutido, *fruta, *lacteo, *carne, *verdura, *aux1;
    float buscarProducto;
                ...
                do{
                    ...
                    switch (option2){
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            printf("De que precio quieres buscar la bebida: ");
                            scanf("%f",&buscarProducto);
                            ele1->datos->precio = buscarProducto;
                            busqueda_binaria_recursiva2(bebida,0,cuenta,ele1,aux1);
                            imprimir_Lista(aux1);
                            break;
                        case 5:
                            bebida = ordenamiento_Refrigerador(bebida,cuenta);
                            break;
                        case 6:
                            vaciar_Lista(bebida);
                            break;
